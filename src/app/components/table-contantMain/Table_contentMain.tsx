...
//     setSelectedProductId(selectedCategoryItem?._id || ""); // Update the selectedProductId or clear it
//   };
...
//     }
//   }, [categoryData, selectedCategory, selectedProductId]);
          ...
          <tbody>
            {isLoadingFilter ? (
              ...
              filterData.tasks.map((item: TProduct, index: number) => (
                <tr key={index} title={item.purpose}>
                  <td>{item.createdAt}</td>
                  <td>{truncateText(item.purpose, 5)}</td>
